    ...
    <main className="flex-1">
      ...
      <section className="px-6 py-8 sm:px-10">
        ...
        <p className="mt-3 max-w-2xl text-xs leading-relaxed text-ash">
          An introduction only sends for a creative who granted it, separate from
          the employer accepting. When both hold, the loop is complete — that is
          the one thing this weekend exists to prove.
        </p>
      </section>
  ...
  if (!creative.mayIntroduce) {
    return (
      <div className="mt-4 border border-rule px-4 py-3">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          {creative.name} has not consented to be introduced.
        ...
        >
          Make introduction — consent needed
        </button>
      </div>
    );
  }
